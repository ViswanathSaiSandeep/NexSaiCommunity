            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', marginBottom: '2.5rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                ...
                <div>
                  ...
                  <a href="mailto:nexsaicommunity@gmail.com" style={{ color: 'var(--text-primary)', textDecoration: 'none', fontWeight: 600, transition: 'var(--transition-fast)', wordBreak: 'break-all', overflowWrap: 'break-word' }} className="email-link">
